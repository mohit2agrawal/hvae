...
def main(params):
    ...
    with tf.Graph().as_default() as graph:
        ...
        with tf.Session() as sess:
            ...
            out_sentence_file = "./generated_sentences_posterior_1.txt"
            out_labels_file = "./generated_labels_posterior_1.txt"
            ...
            with open(out_sentence_file,
                ...
                for num in tqdm(range(number_of_samples)):
                    ...
                    zg_dist, zs_dist = sess.run(
                        [Zglobal_distribition, Zsent_distribution],
                        feed_dict={
                    ...
                    zs_mu, zs_logvar = zs_dist
                    zs_mu = zs_mu[0]
                    zs_logvar = zs_logvar[0]
