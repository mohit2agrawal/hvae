...
def decoder_model(
    ...
    for i in range(max_sent_len):
        ...
        with tf.variable_scope("word"):
            ...
            word_logits_arr.append(word_logits_softmax)
    ...
    if params.beam_search:
        ...
        with tf.variable_scope("label"):
            ...
            label_logits_all / params.temperature, 10)[0]
...
def decoder(
    ...
    with tf.variable_scope("decoder") as sc:
        ...
        if not gen_mode:
            ...
            #zsent_dec_mu, zsent_dec_logvar, zsent_dec_sample
            #zs_dec_mu, zs_dec_logvar, zsent_sample
            #zs_dec_sample
