...
def main(params):
    ...
    with tf.Graph().as_default() as graph:
        ...
        gradients_word = tf.gradients(rec_loss, encoder_word_vars,
	    ...
	    total_parameters = 0
            ...
            for e in tqdm(range(params.num_epochs)):
                            ...
                            while(1):
                                ...
                                if sub_iter % 100 == 0:
                                    ...
                                    if sub_iter == 0:
                                        ...
                                        len_ = 100
                                    burn_cur_loss /= len_
                                    print("Label dec Burn pre loss:", burn_pre_loss, "Burn cur loss:",burn_cur_loss)
                                    if (burn_pre_loss < burn_cur_loss):
                                        print("Break condition true")
                                        break
                                    burn_pre_loss = burn_cur_loss
				...
				aggressive = True
                            ...
                            #     print("STOP BURNING word:", cur_it)
                            # 
                        print("it:", it, "aggressive", aggressive, "aggressive_word", aggressive_word, "aggressive_lable", aggressive_label, "sent mi:%.4f. gmi mi:%.4f. two mi:%.4f. mi_y_zl:%.4f" %(mi_s, mi_g, mi_zc_zl, mi_y_zl))
                        mi_s_prev = mi_s
                        mi_g_prev = mi_g
                        #mi_s_prev = mi_s


                    if (e % 100 == 0 and cur_it != 0) or klw < 5.0:
